...
{
    public partial class Form_ClusterSSEC : Form, Form_Automatable
    {
        Process process = null;
        Model_Automator automationModel = null;

        public Form_ClusterSSEC()
        {
            InitializeComponent();
            ...
            textBox_lotsd.DataBindings.Add("Text", trackBar_lotsd, "Value");
        ...
        {
            LogHelper logger = LogHelper.NewLogger(typeof(Form_ClusterSSEC), textBox_logPath.Text);
        ...
        private void process_OnExited(object sender, EventArgs e)
        {
            ...
            if (textBox_status.InvokeRequired)
            {
                textBox_status.Invoke(new MethodInvoker(delegate()
                {
                    LogHelper.GetLogger(typeof(Form_ClusterSSEC)).Log(textBox_status.Text);
                }));
            }
        }
        ...
        public void Show_withAutomationSettings(Model_Automator automationModel)
        {
                ...
                automationModel.Param2 != null && automationModel.Param4 != null && automationModel.Param5 != null)
            {
                try
                {
                    ...
                    trackBar_lotsd.Value = int.Parse((automationModel.Param2));
                }
                catch (Exception ex)
                {
                ...
                textBox_lotsd.Text = automationModel.Param2;
                textBox_stockPath.Text = automationModel.Param3;
        ...
        public void Form_ConfirmSettings(object sender, EventArgs e)
        {
            if (automationModel != null)
            {
                ...
                automationModel.Param2 = textBox_lotsd.Text;
                automationModel.Param3 = textBox_stockPath.Text;
        ...
        public string Form_Validate(LogHelper logger)
        {
            ...
            toReturn += Validator.fastCheck(textBox_lotsd, Validator.Identifier.INT);
        ...
        public string Form_Execute(LogHelper logger, bool slient)
        {
            ...
            String command = 1 + " " + textBox_noctbd.Text + " " + textBox_stockPath.Text + " " + textBox_clusterPath.Text + " " + textBox_lotsd.Text;
