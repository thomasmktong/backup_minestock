...
{
    public partial class Form_CatByUpDown : Form, Form_Automatable
    {
        Process process = null;
        Model_Automator automationModel = null;

        public Form_CatByUpDown()
        {
            InitializeComponent();
        ...
        {
            LogHelper logger = LogHelper.NewLogger(typeof(Form_CatByUpDown), textBox_logPath.Text);
        ...
        private void process_OnExited(object sender, EventArgs e)
        {
            ...
            if (textBox_status.InvokeRequired)
            {
                textBox_status.Invoke(new MethodInvoker(delegate()
                {
                    LogHelper.GetLogger(typeof(Form_CatByUpDown)).Log(textBox_status.Text);
                }));
            }
        }
        ...
        public string Form_Execute(LogHelper logger, bool slient)
        {
            ...
            String command = 0 + " " + textBox_noctbd.Text + " 1 " + textBox_stockPath.Text + " " + textBox_genusPath.Text + " " + "NIL";
